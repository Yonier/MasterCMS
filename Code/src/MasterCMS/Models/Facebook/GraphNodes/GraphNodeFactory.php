 ...
 *
 */
namespace MasterCMS\Models\Facebook\GraphNodes;
...
class GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = '\MasterCMS\Models\Facebook\GraphNodes\GraphNode';

    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = '\MasterCMS\Models\Facebook\GraphNodes\GraphEdge';

    /**
     * @const string The graph object prefix.
     */
    const BASE_GRAPH_OBJECT_PREFIX = '\MasterCMS\Models\Facebook\GraphNodes\\';
