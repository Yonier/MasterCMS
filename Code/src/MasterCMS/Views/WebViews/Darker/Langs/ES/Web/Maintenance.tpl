<?php
    ...
    if ($this->hotel->getConfig('maintenance')) {
        if (!$this->hotel->getConfig('maintenance_description')) {
            $this->hotel->setConfig('maintenance_description', '<p>¡Hola! No te preocupes <b>{@name}</b> volverá muy pronto. Estamos puliendo algunas cosillas para mejorar tu experiencia. Ten paciencia, en breve estamos de nuevo disponible.</p>');
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="forgotFormulary"> 
                    ...
                    <input type="email" id="fmail" name="mail" minlength="4" autocomplete="off">
