...
function otherOptionsForm() {
    var form = $('#otherOptionsFormulary'),
        active = 0,
        top = $(window).scrollTop(),
        boton = $('#otherOptions');
    ...
    $('#forerror .alert button[data-dismiss="alert"]').click(function(event) {
        event.preventDefault();
        $('#forerror2').hide('blind', 300);
    });
}

function restartForm() {
    var form = $('#restartFormulary'),
        active = 0,
        top = $(window).scrollTop(),
        boton = $('#restart');
